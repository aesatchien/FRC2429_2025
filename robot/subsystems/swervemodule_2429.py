...
class SwerveModule:
    ...
    def setDesiredState(self, desiredState: SwerveModuleState) -> None:
        ...
        wpilib.SmartDashboard.putNumber(f"setting driving controller of module {self.label} to: ", correctedDesiredState.speed)
        ...
        wpilib.SmartDashboard.putNumber(f"setting turning spark flex of {self.label} to ", self.turning_output)
