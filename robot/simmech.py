...
double_pivot_shoulder_length = constants.ShoulderConstants.k_shoulder_length_sim
...
front_elevator.appendLigament("elevator", "elevator_bottom", constants.ElevatorConstants.k_elevator_sim_width, 0, bar_width, wpilib.Color.kRed)
front_elevator.appendLigament("elevator_bottom", "elevator_right", constants.ElevatorConstants.k_pivot_height, 90, bar_width, wpilib.Color.kRed)
front_elevator.appendLigament("elevator_right", "elevator_top", constants.ElevatorConstants.k_elevator_sim_width, 90, bar_width, wpilib.Color.kRed)
front_elevator.appendLigament("elevator_top", "elevator_left", constants.ElevatorConstants.k_pivot_height, 90, bar_width, wpilib.Color.kRed)
...
side_elevator.appendLigament("elevator", "elevator_side", constants.ElevatorConstants.k_pivot_height, 90, bar_width * 1.5, wpilib.Color.kRed)
...
side_elevator.appendLigament("double_pivot_shoulder", "wrist", constants.IntakeConstants.k_wrist_length_sim, 0, 20, constants.ElevatorConstants.k_positions["stow"]["wrist_color_for_ligament"])
