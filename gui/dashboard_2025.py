...
class Ui(QtWidgets.QMainWindow):
    ...
    def initialize_widgets(self):
        ...
        #'qlabel_scoring_up_indicator': {'widget': self.qlabel_scoring_up_indicator, 'nt': '/SmartDashboard/IncScoringUp/running', 'command': '/SmartDashboard/IncScoringUp/running'},
        #'qlabel_scoring_down_indicator': {'widget': self.qlabel_scoring_down_indicator, 'nt': '/SmartDashboard/IncScoringDown/running', 'command': '/SmartDashboard/IncScoringDown/running'},
