...
class Shooter(Subsystem):
    def __init__(self) -> None:
        ...
        self.shooter_l = rev.SparkMax(sc.k_CANID_f1, motor_type)
        self.shooter_r = rev.SparkMax(sc.k_CANID_f2, motor_type)

        # convenient list of motors if we need to query or set all of them
        self.motors = [self.shooter_r, self.shooter_l]
        ...
        self.configs = [sc.k_flywheel_right, sc.k_follower_config_f2]
    ...
    def stop_shooter(self):
        self.shooter_l.setReference(0, rev.CANSparkFlex.ControlType.kVoltage)
        self.shooter_r.setReference(0, rev.CANSparkFlex.ControlType.kVoltage)
