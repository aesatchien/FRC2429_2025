...
k_lower_crank_dict = {
        ...
        "k_number_to_add_to_abs_readout_for_relative": math.radians(30), # we add this value to the abs encoder's readout on init to make the relative encoder good since ^ doesn't work
