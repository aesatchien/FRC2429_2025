...
side_elevator.appendLigament("double_pivot_elbow", "wrist", constants.ElevatorConstants.k_wrist_length, 0, 20, constants.ElevatorConstants.k_positions["stow"]["wrist_color"])
